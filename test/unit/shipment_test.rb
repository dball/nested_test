...
class ShipmentTest < ActiveSupport::TestCase
  ...
  ## address_attributes without id always loses over address_id on a shipment with different address
  ...
  ## address_attributes with id followed by address_id loses to the existing address ?!
  ...
  # address_id followed by address_attributes with id
  # shipment has another address
  # address_id wins
